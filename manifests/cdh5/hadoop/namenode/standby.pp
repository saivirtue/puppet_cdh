# == Class puppet-cdh::cdh5::hadoop::namenode::standby
# Hadoop Standby NameNode.  Include this class instead of
# puppet-cdh::cdh5::hadoop::master on your HA standby NameNode(s).  This
...
#
class puppet-cdh::cdh5::hadoop::namenode::standby inherits puppet-cdh::cdh5::hadoop::namenode {
    # Fail if nameservice_id isn't set.
    if (!$::puppet-cdh::cdh5::hadoop::ha_enabled) {
        fail('Cannot use Standby NameNode in a non HA setup.  Specify journalnodes in the $journalnode_hosts parameter on the puppet-cdh::cdh5::hadoop class to enable HA.')
    }
