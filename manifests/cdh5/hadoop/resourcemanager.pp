# == Class puppet_cdh::cdh5::hadoop::resourcemanager
# Installs and configures Hadoop YARN ResourceManager.
# This will create YARN HDFS directories.
#
class puppet_cdh::cdh5::hadoop::resourcemanager {
    Class['puppet_cdh::cdh5::hadoop'] -> Class['puppet_cdh::cdh5::hadoop::resourcemanager']
    ...
    if !$::puppet_cdh::cdh5::hadoop::yarn_ha_enabled or $::fqdn == $::puppet_cdh::cdh5::hadoop::primary_resourcemanager_host {
        ...
        puppet_cdh::cdh5::hadoop::directory { '/var/log/hadoop-yarn':
            ...
            # the namenode.
            require => [Service['hadoop-hdfs-namenode'], Puppet_cdh::Cdh5::Hadoop::Directory['/var/log']],
